...
<form method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<div class="letak_input" style="margin-bottom: 10px;"></div>
		<input type="file" class="form-control" name="foto[]">
		<span class="btn btn-primary btn_tambah">
...
<script>
	$(document).ready(function(){
		$(".btn_tambah").on("click",function(){
			$(".letak_input").append("<input type='file' class='form-control' name='foto[]''>")
		})
	})
</script>